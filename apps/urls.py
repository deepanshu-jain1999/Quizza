...
urlpatterns = format_suffix_patterns([
    ...
    url(r'^home/profile/$', views.UserProfile.as_view(), name='profile-list'),
    ...
    url(r'^home/category/(?P<category>\w+)/practice/(?P<level>\w+)/result/$', views.GetScore.as_view(), name='result'),
])
